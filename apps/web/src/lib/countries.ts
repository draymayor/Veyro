/**
 * Full country list used across the app wherever a user picks their
 * country (signup form, post-Google-OAuth country selection). Selecting a
 * country sets the user's primary wallet currency, per docs/product-rules.md
 * rule 13.
 */
